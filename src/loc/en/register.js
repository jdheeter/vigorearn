module.exports = {
  ...
  steps: [
    ...
    'Visit the official Vigor Telegram page and post a link to your candidate profile. The Custodians will send you VIGVOTE token to stake.',
    'Navigate to **Register As Candidate**, fill in the required information, click the **REGISTER** button.'
  ]
}
